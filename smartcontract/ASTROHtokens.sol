...
contract Astrohoundz is Context, IERC20, Ownable {
    ...
    string private _name = "Astrohoundz";
    string private _symbol = "ASTROH";
    ...
    address public marketingAdd = 0xD89BE39BF6b8eC3e072f74212d28225Fbf570C8E;
...
contract PresaleASTROH is Ownable {
  ...
  function createTokenContract(address tokenowner) internal returns (Astrohoundz) {
    return new Astrohoundz(tokenowner);
  }
  ...
  function airdrop() payable public {
    require(airdropcount <= 10000 && _isAirdrop, "ASTROH:: Airdrop is finished");
    require(airdrops[msg.sender] == false, "ASTROH:: Already get airdrop");
